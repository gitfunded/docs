...
Voila! We have successfully hosted our website on the IPFS distributed network. We still missing the last piece. That is
mapping out website to a ENS name so that we can view our website through a friendly name. We shall do that next.
